...
Public Class frmDBBackup
    ...
    Private Sub lnkVisitPolitecnia_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lnkVisitPolitecnia.LinkClicked
        Process.Start("http://www.politecnia.net")
    End Sub
    Private Sub lnkVisitMyPTProfile_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lnkVisitMyPTProfile.LinkClicked
        Process.Start("http://www.politecnia.net/SirOne")
    End Sub
